...
TRAIN: list[tuple[str, str, Path]] = [
    ...
    ("Total price — Bengaluru", "ml/pipelines/train_total_price.py bengaluru",
     ROOT / "ml" / "artifacts" / "bengaluru" / "total_price.json"),
    ("Total price — Chennai", "ml/pipelines/train_total_price.py chennai",
     ROOT / "ml" / "artifacts" / "chennai" / "total_price.json"),
